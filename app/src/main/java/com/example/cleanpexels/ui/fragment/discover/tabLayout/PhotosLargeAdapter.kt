...
import com.example.cleanpexels.databinding.LargePhotoItemBinding

class PhotosLargeAdapter :
    PagingDataAdapter<PexelsPhoto, PhotosLargeAdapter.ViewHolderPhotos>(PhotosDiffCallBack()) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderPhotos {
        val dataBinding: LargePhotoItemBinding = DataBindingUtil.inflate(
    ...
    inner class ViewHolderPhotos(private val dataBinding: LargePhotoItemBinding) :
